...
public class ReturnOrderItemController {
    ...
    public Result delete(Long id){
     ...
     /**
      * @UpdateUser:     heiye
      * @UpdateRemark:   退款操作建立在退货之后的基础上
      */

     @PostMapping("/updateRefund")
     public Result updateRefund(@RequestBody String id,String money,String adminId){
         returnOrderItemService.updateRefund(id,money,adminId);
    ...
    public Result updateReject(@RequestBody String id,String remark,String adminId){
        returnOrderItemService.updateReject(id,remark,adminId);
